        ...
        <div className="container mb-5 mt-5">
          ...
          <div className="row">
            <div className="col-12 col-md-8">
              <p className="h4 mb-4 font-weight-bold">Hi, I am Montrell Jubilee.</p>
          ...
          <div className="row">
            <div className="col-12 col-md-12">
              <ul className="list-unstyled list-inline social text-left">
                <li className="list-inline-item"><a href="https://www.facebook.com/mjubilee1"><i className="fa fa-facebook" id="facebook"></i></a></li>
                <li className="list-inline-item"><a href="https://github.com/mjubil1"><i className="fa fa-github twitter" id="github"></i></a></li>
                <li className="list-inline-item"><a href="https://www.linkedin.com/in/montrell-jubilee-2a5a1910a/"><i className="fa fa-linkedin" id="linkedin"></i></a></li>
